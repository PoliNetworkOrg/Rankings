...
export function ArchiveTip({ data }: Props) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-5 dark:border-indigo-900/50 dark:from-indigo-950/30 dark:via-slate-900 dark:to-purple-950/30">
      ...
      <div className="relative flex items-start gap-4">
        <div className="space-y-2">
          ...
          <p className="flex items-center gap-1.5 text-slate-500 text-xs dark:text-slate-400">
            <svg
