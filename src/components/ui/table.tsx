...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-[#E3EBF2] data-[state=selected]:bg-slate-100 dark:data-[state=selected]:bg-slate-800 dark:hover:bg-slate-600/30",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-2 text-left align-middle font-medium text-slate-500 dark:text-slate-400 [&:has([role=checkbox])]:pr-0 [&>*[role=checkbox]]:translate-y-0.5",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-slate-500 text-sm dark:text-slate-400", className)}
    {...props}
  />
))
